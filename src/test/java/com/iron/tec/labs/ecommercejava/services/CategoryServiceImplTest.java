...
class CategoryServiceImplTest {
    ...
    void createCategoryTest() {
        ...
        CategoryDomain createdCategory = categoryService.createCategory(category).block();
    ...
    void testUpdateExisting() {
        ...
        categoryService.updateCategory(category).block();
    ...
    void getCategoryPage() {
        ...
        PageDomain<CategoryDomain> page =
                categoryService.getCategoryPage(0, 1).block();
